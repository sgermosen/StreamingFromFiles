...
namespace BgServicex
{
    public class Worker : BackgroundService
    {
        ...
        //private const string InputMP4FileName = @"Coffee.mp4";
       private const string OutputFolderName = @"Output";
        ...
        protected async void Input_OnCreated(object source, FileSystemEventArgs e)
        {
            if (e.ChangeType == WatcherChangeTypes.Created)
            {
                ...
                using (var scope = _services.CreateScope())
                {
                    ...
                    await RunAsync(config, e.Name, e.FullPath);
        ...
        /// <returns></returns>
        // <RunAsync>
        private static async Task RunAsync(ConfigWrapper config, string inputMP4FileName, string fullPath)
        {
            ...
            _ = await CreateInputAssetAsync(client, config.ResourceGroup, config.AccountName, inputAssetName, inputMP4FileName, fullPath);
            ...
            string fileToUpload, string fullPath)
        {
            ...
            await blob.UploadAsync(fullPath); // fileToUpload);
